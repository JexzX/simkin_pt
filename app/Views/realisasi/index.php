    ...
    <div class="d-flex">
        ...
        <div class="sidebar" style="width: 260px;">
            ...
            <ul class="nav flex-column p-3">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?= base_url('/realisasi') ?>">
                        <i class="fas fa-chart-line me-2"></i> Realisasi
                    </a>
                </li>
        ...
        <div class="content-wrapper w-100">
            ...
            <div class="p-4">
                <div class="alert alert-info">
                    ...
                    Halaman realisasi akan menampilkan input realisasi per bulan setelah SKP disetujui.
                </div>

                <div class="card">
                    <div class="card-body">
                        <p class="text-muted text-center mb-0">
                            Silakan buat SKP terlebih dahulu, lalu setelah disetujui Anda dapat input realisasi.
                        </p>
                    </div>
                </div>
