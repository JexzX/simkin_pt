        ...
        <div class="content-wrapper w-100">
            ...
            <div class="p-4">
                ...
                <div class="alert alert-success alert-dismissible fade show">
                    <?= session()->getFlashdata('success') ?><button type="button" class="btn-close"
                        data-bs-dismiss="alert"></button></div>
                <?php endif; ?>
                <?php if(session()->getFlashdata('error')): ?>
                <div class="alert alert-danger alert-dismissible fade show">
                    <?= session()->getFlashdata('error') ?><button type="button" class="btn-close"
                        data-bs-dismiss="alert"></button></div>
                <?php endif; ?>
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('/rhk/store') ?>" method="post">
                            ...
                            <div class="mb-4 p-3 bg-light rounded">
                                <label class="form-label fw-semibold"><i class="fas fa-arrow-down me-1"></i> Dasar RHK /
                                    Sumber Intervensi</label>
                                <textarea name="intervensi_dari_manual" class="form-control" rows="2"
                                    placeholder="Contoh: Renstra UIN Salatiga, Visi Misi, Kebijakan Pemerintah, dll."></textarea>
                                <small class="text-muted">Tuliskan dasar atau rujukan dari RHK</small>
                            </div>
                            <?php elseif(!empty($intervensiList)): ?>
                            <div class="mb-4 p-3 bg-light rounded">
                                <label class="form-label fw-semibold"><i class="fas fa-arrow-down me-1"></i> RHK Atasan
                                    yang Diintervensi</label>
                                ...
                                <div id="indikatorAtasanContainer" class="mt-3 d-none">
                                    <hr>
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Jenis RHK <span
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Rencana Hasil Kerja <span
                                        class="text-danger">*</span></label>
                                <textarea name="nama_rhk" class="form-control" rows="3" required
                                    placeholder="Masukkan rencana hasil kerja"></textarea>
                            </div>

                            <hr>
                            <button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i> Simpan
                                RHK</button>
                            <a href="<?= base_url('/skp/detail/' . $skp_id) ?>" class="btn btn-secondary"><i
