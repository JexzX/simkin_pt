...
<head>
    ...
    <title>SKP - SIMKIN UIN Salatiga</title>
    ...
    <div class="d-flex">
        ...
        <div class="content-wrapper w-100">
            <nav class="navbar-top d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="<?= base_url('/skp/create') ?>" class="btn btn-primary btn-sm">
                        <i class="fas fa-plus me-1"></i> Buat SKP Baru
                    </a>
                </div>
            </nav>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center">Belum ada SKP. Klik "Buat SKP Baru" untuk memulai.</td>
                                    </tr>
                                    <?php else: ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= date('d/m/Y H:i', strtotime($skp['created_at'])) ?></td>
                                            <td>
                                                <a href="<?= base_url('/skp/detail/' . $skp['id']) ?>" class="btn btn-sm btn-info">Detail</a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
